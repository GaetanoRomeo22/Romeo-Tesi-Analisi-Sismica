...
if __name__ == '__main__':
    ...
    training = TimeSeriesDataSet( # Converto il dataset nel formato richiesto dal TFT
        ...
        time_varying_known_reals=['time_idx', 'day', 'year'], # Parametri che variano nel tempo e di cui si conosce il valore futuro
    ...
    predictions = best_tft.predict(val_dataloader, return_x=True)
    save_results(best_tft, predictions, "height")
...
# wandb.init(project="Romeo-DeepAR-Torch")
...
class DeepARLightningModule(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx: int):  # type: ignore
        ...
        self.log(
            "epoch",  # Nome della metrica
            self.current_epoch,  # Valore dell'epoca corrente
            on_epoch=True,  # Log al termine dell'epoca
            prog_bar=True  # Mostra nella barra di progressione
        )
        '''

...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='TemporalFusionTransformer')
    ...
    parser.add_argument('--model', type=str, required=True, default='TemporalFusionTransformer',
                        help='model name, options: [Autoformer, Transformer, TimesNet]')

    # data loader
    parser.add_argument('--data', type=str, required=True, default='custom', help='dataset type')
    parser.add_argument('--root_path', type=str, default='dataset/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='STRZ-LICO_Height.csv', help='data file')
